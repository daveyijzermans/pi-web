...
export default {
  ...
  'menu.archived': 'Session archived',
  'menu.unarchived': 'Session restored',
  'menu.archiveFailed': 'Archive failed',
  'menu.delete': 'Delete',
  ...
  'composer.sendLater': 'Send later',
  'composer.sendLaterHint': 'Queue this message to be sent at a chosen time',
  'composer.sendLaterAt': 'Send at',
  'composer.sendLaterTomorrow': 'Tomorrow 9:00',
  'composer.sendLaterWindowReset': 'When window resets',
  'composer.sendLaterConfirm': 'Schedule',
  'composer.sendLaterInvalid': 'Pick a valid date and time',
  'composer.sendLaterPast': 'Pick a time in the future',
  'composer.sendLaterEmpty': 'Type a message or attach a file first',
  'composer.scheduledFor': 'Scheduled for {time}',
  'composer.attachmentCount': '{count} attachment(s)',
  'composer.planResets': 'resets {time}',
